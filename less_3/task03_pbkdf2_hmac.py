...
# hash_name='sha256' – это алгоритм получения хеш дайджеста для функции pbkdf2_hmac()
# password=b'any_password' – это пароль, для которого проводится вычисление.
# salt=b'any_salt_1' – соль
# iterations=100000 – количество итераций в вычислении (с ростом этого числа растет время вычислений)
# При работе с представленным алгоритмом правильно говорить, что генерируется ключ
# (b'6e97bad21f6200f9087036a71e7ca9fa01a59e1d697f7e0284cd7f9b897d7c02'), а не хеш. 
